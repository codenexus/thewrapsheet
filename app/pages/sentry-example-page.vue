...
<template>
  ...
  <div>
    <main>
      ...
      <p class="description">
        Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://codenexus.sentry.io/issues/?project=4511220825391104">Issues Page</a>.
